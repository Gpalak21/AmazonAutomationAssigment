...
public class GalaxyTest extends BaseTest {
    ...
    public void searchGalaxyAndAddToCart(){
        ...
        By galaxyRows = By.xpath("//div[@role='listitem']");
        List<WebElement> galaxyPhoneList = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(galaxyRows));


        WebElement firstRow = galaxyPhoneList.get(0);
        WebElement productLink = firstRow.findElement(By.tagName("a"));
